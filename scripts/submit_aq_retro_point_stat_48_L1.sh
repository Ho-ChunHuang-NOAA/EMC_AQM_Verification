...
while [ ${NOW} -le ${LASTDAY} ]; do
    ...
    if [ -s ${fcst_dir}/cs.${PDYm2}/aqm.t06z.awpozcon_bc.f48.148.grib2 ] || [ -s ${fcst_dir}/cs.${PDYm2}/aqm.t12z.awpozcon_bc.f48.148.grib2 ]; then
