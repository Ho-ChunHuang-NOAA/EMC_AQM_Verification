...
script_base=run_${jobname}.template793
...
while [ ${NOW} -le ${LASTDAY} ]; do
    ...
    if [ -s ${fcst_dir}/cs.${PDYm3}/aqm.t06z.ave_24hr_pm25.793.grib2 ] || [ -s ${fcst_dir}/cs.${PDYm3}/aqm.t12z.ave_24hr_pm25.793.grib2 ]; then
