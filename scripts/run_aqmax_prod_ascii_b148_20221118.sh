#!/bin/bash
#PBS -N aqmax_prod_ascii_b148_20221118
#PBS -o /lfs/h2/emc/ptmp/ho-chun.huang/VERF_logs/aqmax_prod_ascii_b148_20221118.log
#PBS -e /lfs/h2/emc/ptmp/ho-chun.huang/VERF_logs/aqmax_prod_ascii_b148_20221118.log
#PBS -q dev
#PBS -A AQM-DEV
...
export DATEm3=20221115
export DATEm2=20221116
export DATEm1=20221117
export DATE=20221118
export DATEp1=20221119
export MET_PLUS=/lfs/h2/emc/vpppg/save/ho-chun.huang/METplus-4.0.0
...
## 
export FCST_INPUT_COMOUT=/lfs/h2/emc/physics/noscrub/ho-chun.huang/verification/aqm/prod_ascii
...
## 
export OBS_INPUT_SELECT=/lfs/h2/emc/vpppg/noscrub/ho-chun.huang/dcom_ascii2nc_airnow
...
POINT_STAT_OBS_WINDOW_BEGIN = -864000000
POINT_STAT_OBS_WINDOW_END   =  864000000
...
OBS_POINT_STAT_INPUT_TEMPLATE = {valid?fmt=%Y%m%d}/airnow_daily_{valid?fmt=%Y%m%d}.nc
POINT_STAT_OUTPUT_TEMPLATE = ${envir}
EOF

${METPLUS_PATH}/ush/run_metplus.py -c ${MET_PLUS}/parm/use_cases/grid_to_obs/grid_to_obs_ascii.conf -c ${MET_PLUS}/parm/use_cases/grid_to_obs/examples/conus_surface.conf -c ${MET_PLUS_CONF}/point_stat_${model}.conf -c ${MET_PLUS_TMP}/shared.conf_aqmax -c ${MET_PLUS_CONF}/system_aq.conf -c ${MET_PLUS_TMP}/fcst_input_temp_${model}.conf -c ${MET_PLUS_TMP}/user_priority.conf
