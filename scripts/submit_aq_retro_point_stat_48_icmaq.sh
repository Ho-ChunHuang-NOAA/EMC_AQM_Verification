...
while [ ${NOW} -le ${LASTDAY} ]; do
    ...
    if [ -s ${fcst_dir}/aqm.${PDYm3}/aqm.t06z.awpozcon.f48.148.grib2 ] || [ -s ${fcst_dir}/aqm.${PDYm3}/aqm.t12z.awpozcon.f48.148.grib2 ]; then
