...
while [ ${NOW} -le ${LASTDAY} ]; do
    ...
    if [ -s ${fcst_dir}/cs.${PDYm2}/aqm.t06z.awpozcon.f48.148.grib2 ] || [ -s ${fcst_dir}/cs.${PDYm2}/aqm.t12z.awpozcon.f48.148.grib2 ]; then
