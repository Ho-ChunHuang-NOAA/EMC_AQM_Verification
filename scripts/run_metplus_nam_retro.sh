...
#PBS -N metplus_namretro
#PBS -o /lfs/h2/emc/ptmp/ho-chun.huang/output/metplus_namretro.o%J
#PBS -e /lfs/h2/emc/ptmp/ho-chun.huang/output/metplus_namretro.o%J
#PBS -q dev
#PBS -A VERF-DEV
# 
...
export MET_PLUS_TMP=/lfs/h2/emc/ptmp/ho-chun.huang/metplus_namretro
...
export MET_PLUS_OUT=/lfs/h2/emc/physics/noscrub/Perry.Shafran/metplus_cam
export MET_PLUS_STD=/lfs/h2/emc/ptmp/ho-chun.huang/metplus_namretro_${DATE}
...
cat << EOF > ${model}.conf
[dir]
FCST_POINT_STAT_INPUT_DIR = /lfs/h2/emc/physics/noscrub/Perry.Shafran/com/nam/prod
OBS_POINT_STAT_INPUT_DIR = {OUTPUT_BASE}/cam/conus_cam
PB2NC_INPUT_DIR = /lfs/h2/emc/physics/noscrub/Perry.Shafran/com/nam/prod
[config]
...
/lfs/h2/emc/physics/noscrub/Perry.Shafran/aws/mv_load_to_aws.sh perry.shafran ${MET_PLUS_TMP}/stat/ ${MET_PLUS_TMP}/load_met_nam.xml

cp /lfs/h2/emc/ptmp/ho-chun.huang/output/metplus_nam.out $MET_PLUS_STD/metplus_nam_$DATE.out
