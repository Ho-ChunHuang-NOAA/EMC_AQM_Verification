...
while [ ${NOW} -le ${LASTDAY} ]; do
    ...
    if [ -s ${fcst_dir}/cs.${PDYm2}/aqm.t06z.ave_24hr_pm25_bc.227.grib2 ] || [ -s ${fcst_dir}/cs.${PDYm2}/aqm.t12z.ave_24hr_pm25_bc.227.grib2 ]; then
